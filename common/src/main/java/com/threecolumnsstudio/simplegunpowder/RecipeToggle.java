...
enum RecipeToggle {
    ...
    REFINED_SULFUR("refined_sulfur_gunpowder", SimpleGunpowderConfig::isRefinedSulfurRecipeEnabled),
    POTENT_SULFUR("potent_sulfur_gunpowder", SimpleGunpowderConfig::isPotentSulfurRecipeEnabled),
